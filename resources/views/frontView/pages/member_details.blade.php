...
@section('title','VeroDate 2019 Single Member Page')


@section('singlemembercontent')
    ...
    <div class="profiles_inners">
        <div class="container">
            <div class="profile_content">
                <div class="user_img">
                    <img class="img-circle" src="{{ asset('img/members/single_members.png') }}" alt="">
                </div>
                <div class="user_name">
                    <h3>{{ $singleprofile->email }}</h3>
                    <h4>26 years old</h4>
                    <ul>
                ...
                <div class="right_side_content">
                    ...
                    <button type="submit" value="LogIn" class="btn form-control login_btn">Add Friend <img src="{{ asset('img/user.png') }}" alt=""></button>
                    <button type="submit" value="LogIn" class="btn form-control login_btn">Chat Now <img src="{{ asset('') }}" alt=""></button>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div role="tabpanel" class="tab-pane active fade in" id="profile">
                            ...
                            <div class="profile_list">
                                ...
                                <ul>
                                    ...
                                    <li><a href="#">{{ $singleprofile->gender }}</a></li>
                                    <li><a href="#">26 years old</a></li>
                                    <li><a href="#">France</a></li>
                                    <li><a href="#">Paris</a></li>
                                    <li><a href="#">{{ $singleprofile->dob }}</a></li>
                                    <li><a href="#">Single</a></li>
                                    <li><a href="#">Man</a></li>
                                    <li><a href="#">Designer</a></li>
            ...
            <div class="col-md-3">
                <div class="right_sidebar_area">
                    <aside class="s_widget photo_widget">
                        ...
                        <ul>
                            <li><a href="#"><img src="{{ asset('img/photo/photo-1.jpg') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('img/photo/photo-2.jpg') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('img/photo/photo-3.jpg') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('img/photo/photo-4.jpg') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('img/photo/photo-5.jpg') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('img/photo/photo-6.jpg') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('img/photo/photo-7.jpg') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('img/photo/photo-8.jpg') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('img/photo/photo-9.jpg') }}" alt=""></a></li>
                        </ul>
                    </aside>
                    <aside class="s_widget recent_post_widget">
                        ...
                        <div class="media">
                            <div class="media-left">
                                <img src="{{ asset('img/blog/recent-post/recent-post-1.jpg') }}" alt="">
                            </div>
                        ...
                        <div class="media">
                            <div class="media-left">
                                <img src="{{ asset('img/blog/recent-post/recent-post-2.jpg') }}" alt="">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="media">
                            <div class="media-left">
                                <img src="{{ asset('img/blog/recent-post/recent-post-3.jpg') }}" alt="">
                            </div>
                            <div class="media-body">
                                <h4>Blog Image Post</h4>
                                <a href="#">14 Sep, 2016 at 08:00 Pm</a>
